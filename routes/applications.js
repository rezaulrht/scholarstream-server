...
router.post("/applications", verifyFirebaseToken, async (req, res) => {
  try {
...
router.get("/applications", verifyFirebaseToken, verifyAdmin, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
...
router.get("/applications/user/:email", verifyFirebaseToken, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
...
router.get("/applications/moderator", verifyFirebaseToken, verifyModerator, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
...
router.get("/applications/:id", verifyFirebaseToken, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
...
router.patch("/applications/:id/feedback", verifyFirebaseToken, verifyModerator, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
    const id = req.params.id;
...
router.patch("/applications/:id/status", verifyFirebaseToken, verifyModerator, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
    const id = req.params.id;
...
router.patch("/applications/:id", verifyFirebaseToken, async (req, res) => {
  try {
    const { applicationCollection } = getCollections();
    const id = req.params.id;
    const email = req.decoded_email;
